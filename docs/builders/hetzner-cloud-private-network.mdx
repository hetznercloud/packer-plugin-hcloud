...
If you don't specify the ip_address the IP Assignment is the first available IP Address within the Network,
if you just set the network without the subnet, the subnet gets choosen randomly.  
The subnet needs to be set as CIDR Format i.E "10.1.1.0/24".
